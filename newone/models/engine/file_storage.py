#!/usr/bin/python3
"""This module implements a file storage system for storing and retrieving data.

This module provides a class, FileStorage, which serves as a simple database management system
for an Airbnb clone or similar application. It allows storing Python objects as JSON serialized
data in a file.
...
Methods:
    ...
    new(obj): Sets the given object in __objects with key <obj class name>.id.
    save(): Serializes __objects to the JSON file (__file_path).
    classes(): Returns a dictionary of valid classes and their references.
    reload(): Reloads stored objects from the JSON file.
    attributes(): Returns the valid attributes and their types for each class.
"""
...
class FileStorage():
    ...
    def save(self):
        ...
        # Serialize the objects by first converting them to a dictionary
        object_dict = {}
